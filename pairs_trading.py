...
if __name__ == '__main__':
    ...
    def plot_forecasts(data_df, n_forecasts=50, n_last_points=80):
        # parameters
        ...
        for i, time_series_i in enumerate(windows):
            ...
            ts_forecasts[i] = forecast_future_values_tvAR_p(alpha_extrapolated, time_series_i)
    ...
    # data_df = download_and_prepare_data("BTC-USD", "ETH-USD", period="1y", interval="1h")
    ...
    # data_df.to_csv("data/27_07_2022.csv", index=False)
    # data_df = pd.read_csv("data/27_07_2022.csv")

    # make_general_plots(data_df)
    plot_forecasts(data_df)
    plt.show()
